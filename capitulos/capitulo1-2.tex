...
\begin{proof}
  ...
  Sea $\lambda_1 v_i' + \cdots + \lambda_n v_n' = 0$, por linealidad de $[\cdot]_B$ y definición, tenemos que si $\lambda = (\lambda_1, \cdots, \lambda_n)^T$, entonces
  \begin{align*}
    \lambda_1 [v_i']_B + \cdots + \lambda_n [v_n']_B &= \bec 0 ,\\
